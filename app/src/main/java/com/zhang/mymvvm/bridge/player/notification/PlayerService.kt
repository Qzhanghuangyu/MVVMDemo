package com.zhang.mymvvm.bridge.player.notification
...
import com.zhang.architecture.utils.ImageUtils
...
import com.zhang.mymvvm.bridge.player.helper.PlayerCallHelper
import java.io.File
...
class PlayerService : Service() {
    ...
    companion object {
        const val NOTIFY_PREVIOUS = "pure_music.zhang.previous"
        const val NOTIFY_CLOSE = "pure_music.zhang.close"
        const val NOTIFY_PAUSE = "pure_music.zhang.pause"
        const val NOTIFY_PLAY = "pure_music.zhang.play"
        const val NOTIFY_NEXT = "pure_music.zhang.next"
